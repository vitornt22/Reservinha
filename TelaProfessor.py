...
class Ui_MenuProfessor(object):
    def setupUi(self, MenuCoordenador,professor):
    ...
    def retranslateUi(self, MenuCoordenador):
        ...
        MenuCoordenador.setWindowTitle(_translate("MenuCoordenador", "MENU PROFESSOR"))
        self.Cpf.setText(_translate("MenuCoordenador", "CPF               "))
        self.Email.setText(_translate("MenuCoordenador", "EMAIL          "))
        self.Siape.setText(_translate("MenuCoordenador", "MATRICULA "))
        ...
        self.Tabelageral.setTabText(self.Tabelageral.indexOf(self.cadastrarprofessor), _translate("MenuCoordenador", "Cadastrar monitor"))
...
if __name__ == "__main__":
    ...
    ui = Ui_MenuProfessor()
    ui.setupUi(MenuCoordenador,professor=None)
